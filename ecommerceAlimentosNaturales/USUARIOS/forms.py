...
class RegistroForm(UserCreationForm):
    ...
    email = forms.EmailField(label = 'Email', widget = forms.TextInput(attrs={'class': 'form-control'}), max_length = 254, required = True, help_text = 'Se requiere una direccion de e-mail valida.')
    class Meta:
        model=User
